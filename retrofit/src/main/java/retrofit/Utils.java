...
final class Utils
{
  ...
  private static List<String> methodsWithBody = Lists.newArrayList("PUT", "POST", "PATCH");

  static boolean requestAllowsBody(HttpMethod method)
  {
    return methodsWithBody.contains(method.value().toUpperCase());
  }
