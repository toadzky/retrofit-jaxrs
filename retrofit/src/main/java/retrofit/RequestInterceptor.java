...
public interface RequestInterceptor
{
  ...
  interface RequestFacade
  {
    ...
    /**
     * Add a path parameter replacement. This works exactly like a {@link javax.ws.rs.PathParam
     * &#64;PathParam}-annotated method argument.
     */
    void addPathParam(String name, String value);

    /**
     * Add a path parameter replacement without first URI encoding. This works exactly like a
     * {@link javax.ws.rs.Encoded &#64;Encoded}-annotated method argument.
     */
