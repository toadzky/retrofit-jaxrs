...
final class RequestBuilder implements RequestInterceptor.RequestFacade
{
  ...
  public void addHeader(String name, String value)
  {
    if (name == null)
    {
      throw new IllegalArgumentException("HeaderParam name must not be null.");
    }
  ...
  void addPathParam(String name, String value, boolean urlEncodeValue)
  {
    if (name == null)
    {
      throw new IllegalArgumentException("PathParam replacement name must not be null.");
    }
    if (value == null)
    {
      throw new IllegalArgumentException(
          "PathParam replacement \"" + name + "\" value must not be null.");
    }
    try
    {
      if (urlEncodeValue)
      {
        ...
        // URLEncoder encodes for use as a query parameter. PathParam encoding uses %20 to
        // encode spaces rather than +. QueryParam encoding difference specified in HTML spec.
  ...
  void addQueryParam(String name, String value, boolean urlEncodeValue)
  {
    if (name == null)
    {
      throw new IllegalArgumentException("QueryParam param name must not be null.");
    }
    if (value == null)
    {
      throw new IllegalArgumentException("QueryParam param \"" + name + "\" value must not be null.");
    }
    try
    {
      if (urlEncodeValue)
    ...
    for (int i = 0; i < count; i++)
    {
      ...
      switch (paramUsage)
      {
        case PATH:
          ...
          {
            throw new IllegalArgumentException(
                "PathParam parameter \"" + name + "\" value must not be null.");
          }
