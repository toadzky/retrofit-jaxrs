 ...
 * the request type. The built-in methods are {@link javax.ws.rs.GET GET},
 * {@link javax.ws.rs.PUT PUT}, {@link javax.ws.rs.POST POST}, {@link javax.ws.rs.HEAD HEAD},
 * and {@link javax.ws.rs.DELETE DELETE}. You can define your own HTTP method by creating an
 * annotation that takes a {code String} value and itself is annotated with
 * {@link javax.ws.rs.HttpMethod @HttpMethod}.
 * <p/>
 * Method parameters can be used to replace parts of the URL by annotating them with
 * {@link javax.ws.rs.PathParam @PathParam}. Replacement sections are denoted by an identifier surrounded
 ...
 * </ul>
 * <p/>
 * The body of a request is the only parameter that does not have a JAX-RS annotation. The object
 ...
 * <p/>
 * For per-request control over a header
 * annotate a parameter with {@link Header @HeaderParam}.
 * <p/>
 * For example:
 * <pre>
 * public interface MyApi {
 *   &#64;POST("/category/{cat}") // Asynchronous execution.
 *   void categoryList(@PathParam("cat") String a, @QueryParam("page") int b, Callback&lt;List&lt;Item>> cb);
 *   &#64;POST("/category/{cat}") // Synchronous execution.
 *   List&lt;Item> categoryList(@PathParam("cat") String a, @QueryParam("page") int b);
 * }
 * </pre>
 * <p/>
