...
public class RequestBuilderTest
{
  ...
  @Test
  public void getWithPathParam() throws Exception
  {
    Request request = new Helper() //
        .setMethod("GET") //
        .setUrl("http://example.com") //
  ...
  @Test
  public void getWithInterceptorPathParam() throws Exception
  {
    Request request = new Helper() //
        .setMethod("GET") //
        .setUrl("http://example.com") //
  ...
  @Test
  public void getWithPathParamAndInterceptorPathParam() throws Exception
  {
    Request request = new Helper() //
        .setMethod("GET") //
        .setUrl("http://example.com") //
  ...
  @Test
  public void getWithInterceptorQueryParam() throws Exception
  {
    Request request = new Helper() //
        .setMethod("GET") //
        .setUrl("http://example.com") //
  ...
  @Test
  public void getWithPathParamAndInterceptorQueryParam() throws Exception
  {
    Request request = new Helper() //
        .setMethod("GET") //
        .setUrl("http://example.com") //
  ...
  @Test
  public void getWithInterceptorPathParamAndInterceptorQueryParam() throws Exception
  {
    Request request = new Helper() //
        .setMethod("GET") //
        .setUrl("http://example.com") //
  ...
  @Test
  public void pathParamRequired() throws Exception
  {
    try
    {
      new Helper() //
    ...
    {
      assertThat(e.getMessage()).isEqualTo("PathParam parameter \"ping\" value must not be null.");
    }
  }

  @Test
  public void getWithQueryParam() throws Exception
  {
    Request request = new Helper() //
        .setMethod("GET") //
        .setUrl("http://example.com") //
  ...
  @Test
  public void getWithQueryUrlAndParam() throws Exception
  {
    Request request = new Helper() //
        .setMethod("GET") //
        .setUrl("http://example.com") //
  ...
  @Test
  public void getWithPathAndQueryQuestionMarkParam() throws Exception
  {
    Request request = new Helper() //
        .setMethod("GET") //
        .setUrl("http://example.com") //
  ...
  @Test
  public void getWithPathAndQueryAmpersandParam() throws Exception
  {
    Request request = new Helper() //
        .setMethod("GET") //
        .setUrl("http://example.com") //
  ...
  @Test
  public void getWithPathAndQueryHashParam() throws Exception
  {
    Request request = new Helper() //
        .setMethod("GET") //
        .setUrl("http://example.com") //
  ...
  @Test
  public void normalPost() throws Exception
  {
    Request request = new Helper() //
        .setMethod("POST") //
        .setHasBody() //
  ...
  @Test
  public void normalPostWithPathParam() throws Exception
  {
    Request request = new Helper() //
        .setMethod("POST") //
        .setHasBody() //
  ...
  @Test
  public void bodyRequired() throws Exception
  {
    try
    {
      new Helper() //
  ...
  @Test
  public void multipartPartOptional() throws Exception
  {
    try
    {
      new Helper() //
  ...
  @Test
  public void simpleFormEncoded() throws Exception
  {
    Request request = new Helper() //
        .setMethod("POST") //
        .setHasBody() //
  ...
  @Test
  public void formEncodedFieldOptional() throws Exception
  {
    Request request = new Helper() //
        .setMethod("POST") //
        .setHasBody() //
  ...
  @Test
  public void noDuplicateSlashes() throws Exception
  {
    Request request = new Helper() //
        .setMethod("GET") //
        .setUrl("http://example.com/") //
  ...
  private static class Helper
  {
    ...
    Request build() throws Exception
    {
      ...
      if (path == null)
      {
        throw new IllegalStateException("PathParam must be set.");
      }
